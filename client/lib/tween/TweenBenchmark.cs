...
public class TweenBenchmark
{
		...
		{
			DF.Lib.Tween.Tween<float, bool> x = new(DF.Lib.Tween.InterpolationType.Linear);
			...
			for (ulong i = 0; i < n_points; i++) {
				x.Add(new System.Collections.Generic.List<DF.Lib.Tween.Frame<float, bool>>{
