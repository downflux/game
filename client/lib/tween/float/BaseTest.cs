...
public class BaseTest
{
	...
	public void TestIntercept()
	{
		...
		AssertThat(  // FallingEdge
			this._t.Intercept(
				...
				new(20, 110, true),
				115,
				DF.Lib.Tween.Float.EdgeType.FallingEdge)).IsEqual(
			new DF.Lib.Tween.Frame<float, bool?>(15, 115, null, false));
		AssertThat(  // keyframe
			this._t.Intercept(
				new(10, 110, true),
	...
	{
		AssertThat(  // OOB
			this._t.Find(null, null, 100, DF.Lib.Tween.Float.EdgeType.RisingEdge)).IsEmpty();
		AssertThat(  // OOB
			this._t.Find(null, 9, 100, DF.Lib.Tween.Float.EdgeType.RisingEdge)).IsEmpty();
		AssertThat(  // OOB
			this._t.Find(51, null, 100, DF.Lib.Tween.Float.EdgeType.RisingEdge)).IsEmpty();

		AssertThat(
			this._t.Find(10, 15, 111, DF.Lib.Tween.Float.EdgeType.FallingEdge)).IsEmpty();
		AssertThat(
			this._t.Find(10, 15, 111, DF.Lib.Tween.Float.EdgeType.RisingEdge)).IsEqual(
				new List<DF.Lib.Tween.Frame<float, bool?>> {
					new (11, 111, null, false)
				});
		AssertThat(  // Multiple intercepts.
			this._t.Find(20, 50, 121, DF.Lib.Tween.Float.EdgeType.RisingEdge)).IsEqual(
				new List<DF.Lib.Tween.Frame<float, bool?>> {
		...
		AssertThat(
			this._t.Find(30, 40, 129, DF.Lib.Tween.Float.EdgeType.RisingEdge)).IsEmpty();
		AssertThat(
			this._t.Find(30, 40, 129, DF.Lib.Tween.Float.EdgeType.FallingEdge)).IsEqual(
				new List<DF.Lib.Tween.Frame<float, bool?>> {
